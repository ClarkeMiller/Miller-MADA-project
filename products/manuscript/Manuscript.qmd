...
#| echo: FALSE
knitr::include_graphics(here("products","assets","World Flu by Cladep.png"))
...
1. Can the progression of flu outbreaks be traced geographically and temporally over the course of a year?
